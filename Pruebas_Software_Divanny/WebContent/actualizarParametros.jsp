...
function modificar(){
	...
	document.getElementById('seguro4').disabled=false;
}
function cancelar(){
	...
	document.getElementById('seguro4').disabled=true;
	...
	document.getElementById('seguro4').value="<%=parametros.get(3).getPorcentaje()%>"
}
</script> 
...
<br><br><%=parametros.get(3).getNombre() %> : &nbsp &nbsp<input type="number" id="seguro<%=parametros.get(3).getId_seg()%>" style="width: 60px;" max="99,99" min="1,00" name="seguro4" value="<%=parametros.get(3).getPorcentaje()%>" size="3" disabled>%
