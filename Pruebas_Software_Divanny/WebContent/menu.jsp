...
<div id="menunobu0" style="margin-left: 180px;">
        ...
        <ul> <%if(usuario.getPerfilD().equalsIgnoreCase("Contador")){ %><li><a href="#" >Planillas Semanales</a></li> <li><a href="#">Planillas Mensuales</a></li><%} %>
        ...
        <ul> 
        <li><a href="Empleado?accion=listar">Empleados</a></li> <li><a href="usuarios.jsp">Usuarios</a></li>
        </ul><%} %>
        </li>
